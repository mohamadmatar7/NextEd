                    ...
                    <div
                        ...
                        <nav>
                            ...
                            <a href="{{ route('dashboard') }}"
                                ...
                                <svg class="h-5 w-7 mr-1" fill="none" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <details class="w-full cursor-pointer">
                            <summary class="flex items-center text-base leading-6 py-2 font-semibold hover:bg-primary hover:text-white">
                                <div
                                    class="inline-flex justify-start items-center px-3 text-sm leading-4 font-medium w-full">
                ...
                <div class="nav-toggle hidden md:block">
                    <nav class="mt-5">
                        ...
                        <a href="{{ route('dashboard') }}"
                            ...
                            <svg class="h-6 w-8" fill="none" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" stroke="currentColor" viewBox="0 0 24 24">
                                <rect x="3" y="3" width="7" height="7"></rect>
                                <rect x="14" y="3" width="7" height="7"></rect>
                                <rect x="14" y="14" width="7" height="7"></rect>
                    ...
                    <details class="w-full my-6 cursor-pointer">
                        <summary class="flex-shrink-0 flex hover:bg-primary hover:text-white rounded-r-full">
                            <div
                                class="flex flex-col justify-center items-center px-3 py-2 text-sm leading-4 font-medium w-full">
                                <!-- User Avatar -->
                                @if (Auth::user()->hasMedia('avatars'))
                                <img class="h-8 w-8 rounded-full mb-1"
                                    src="{{ Auth::user()->getMedia('avatars')->last()->getUrl() }}"
